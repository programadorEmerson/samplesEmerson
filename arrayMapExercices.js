...
// Usando Map e Filter para retornar nome e sobrenome
//  O filter filtrou o array e através do resultado obtido ja combinou um map para gerar um novo array com base nas informações do filter.
const allNameStudents = estudantes.filter(
    (estudante) => (estudante.turno === 'Manhã')).map(
